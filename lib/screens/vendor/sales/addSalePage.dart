    ...
    try {
      ...
      for (final categoryDoc in categoriesSnapshot.docs) {
        ...
        if (subcategoriesSnapshot.docs.isNotEmpty) {
          // This category has subcategories - get products from each subcategory
          ...
          // This category has no subcategories - get products directly
          final productsSnapshot = await FirebaseFirestore.instance
              .collection('stalls')
              .doc(widget.stallId)
              .collection('categories')
      ...
      if (mounted) {
        ...
        showModalBottomSheet(
          ...
          builder: (context) => availableProducts.isEmpty
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      onTap: () => _showQuantitySelector(product),
                    );
                  },
                ),
              ),
