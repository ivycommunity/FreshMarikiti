...
class _EditProductPageState extends State<EditProductPage> {
  ...
  CollectionReference<Map<String, dynamic>> _productCollection() {
    ...
    if (widget.subcategoryId != null) {
      ...
      return base.collection('products');
    }
  }

  Future<void> _loadProductData() async {
    final doc = await _productCollection().doc(widget.productId).get();
    if (doc.exists) {
  ...
  Future<String?> _uploadImage() async {
    ...
    final path = widget.subcategoryId != null
        ? 'products/${widget.stallId}/${widget.categoryId}/${widget.subcategoryId}/${widget.productId}.jpg'
        : 'products/${widget.stallId}/${widget.categoryId}/${widget.productId}.jpg';
